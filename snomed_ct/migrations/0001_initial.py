# Generated by Django 3.2.13 on 2022-12-22 19:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transitive_subsumes', to='snomed_ct.concept')),
                ('start', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transitive_isa', to='snomed_ct.concept')),
            ],
        ),
        migrations.CreateModel(
            name='TextDefinition',
